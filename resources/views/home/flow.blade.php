				...
				<div class="box_flow">
					...
					<div id="bm">
						<div class="bm">
							...
							<div class="bm_con">
								<form id="feedback_form" action="{{url('apply/flow.html')}}" method="post" novalidate>
									@csrf
									<div class="left form-box">
										<ul>
											<li>
												...
												<input id="txtUserName" name="name" class="weui-input" type="text" placeholder="我们期待更了解您" />
											</li>
											<li>
												<span class="l_text"><s style="color:#e00000; font-size:15px; text-decoration:none; padding-right:5px;">*</s>上课地址</span>
												 <select name="campus_id" id="txtUserEmail" style="width:212px; height:36px; display:block;">
													@foreach($campus as $v)
											...
											<li>
												...
												<input id="txtUserTel" name="tel" class="weui-input" type="tel" placeholder="我们和您一样讨厌骚扰电话" />
											</li>
											<li>
												<span class="l_text"><s style="color:#e00000; font-size:15px; text-decoration:none; padding-right:5px;">*</s>报名学科</span>
												<select name="course_id" id="txtContent" style="width:212px; height:36px; display:block;">
											...
											<li>
												...
												<input id="txtUserQQ" name="qq" class="weui-input" type="text" placeholder="我们将尽快与您联系" />
											</li>
										</ul>
										<br>
									</div>
									<div class="right form-group">
										<input id="btnSubmit" onclick="return check()" type="submit" class="weui-btn weui-btn_primary" value="现在预报名" />
