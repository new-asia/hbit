    ...
    <div class="base">
        ...
        <div class="qj_main">
            <div class="fl">
                ...
                <a rel="nofollow" href="javascript:void(0)" class="btn">了解市场走向</a>
            </div>
            <div class="fr">
                <img src="/static/templates/main/images/qj_img2.jpg">
                <a rel="nofollow" href="javascript:void(0)" class="btn">获取更多数据</a>
            </div>
        </div>
    </div>
</div>
...
<div class="kecheng section c6" id="hash-dagang" title="HTML5培训|H5培训|前端培训|鸿博HTML5学院">
    <div class="base warp">
        ...
        <div class="j-c6-cont">
            ...
            <div class="active">
                <table>
                    ...
                    <tr>
                        <td rowspan="3">
                            <h4>第一阶段：<br>前端页面重构</h4>
                        </td>
                        <td>
                            <h4>项目一、<br>PC端网站布局项目</h4>
                        </td>
                        <td colspan="2">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <p>- rem/vw的使用</p>
                            <p>- flexbox详解</p>
                            <p>- 移动web特别样式处理（reset, 1px border, 高清图片）</p>
                    ...
                    <tr>
                        <td rowspan="3">
                            <h4>第二阶段：<br>JavaScript高级程序设计</h4>
                        </td>
                        <td>
                            <h4>项目四、<br>原生JavaScript交互功能开发项目</h4>
                        </td>
                        <td colspan="2">
                            <p>- 基本语法</p>
                            <p>- 循环语句</p>
                    ...
                    <tr>
                        <td rowspan="4">
                            <h4>第三阶段：<br>PC端全栈项目开发</h4>
                        </td>
                        <td>
                            <h4>项目七、<br>jQuery经典交互特效开发</h4>
                        </td>
                        <td colspan="2">
                            <p>- 时间轴特效</p>
                            <p>- tab页面切换效果</p>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <p>- MySQL</p>
                            <p>- HTTP(s)协议详解</p>
                            <p>- Ajax进阶、跨域与Defered</p>
                            <p>- Apache与Nginx 环境搭建与配置</p>
                            <p>- 接口的定义</p>
                            <p>- Mock数据</p>
                            <p>- Restful</p>
                            <p>- 前后端联调</p>
                    ...
                    <tr>
                        <td rowspan="3">
                            <h4>第四阶段：<br>移动端WebApp开发</h4>
                        </td>
                        <td>
                            <h4>项目十一、<br>应用Vue.js开发WebApp项目</h4>
                        </td>
                        <td colspan="2">
                            <p>- Vue.js基础</p>
                            <p>- 模块化</p>
                            ...
                            <p>- 状态管理</p>
                            <p>- 单元测试与生产发布</p>
                            <p>- 服务端渲染SSR与Nuxt.js</p>
                            <p>- 基于Vue.js企业级项目开发(Mint UI, Element UI)</p>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <p>- 组件</p>
                            <p>- flux+Redux</p>
                            <p>- React<p>-Router路由</p>
                                <p>- 动画效果</p>
                                <p>- 基于React 企业级项目研发( Antd, Antd Mobile)</p>
                    ...
                    <tr>
                        <td rowspan="4">
                            <h4>第五阶段：<br>混合(Hybrid,RN)开发</h4>
                        </td>
                        <td>
                            <h4>项目十四、<br>微信公众号开发</h4>
                        </td>
                        <td colspan="2">
                            <p>- 初识微信公众号</p>
                            <p>- 订阅号的基本功能</p>
                            <p>- 使用百度BAE实现代码的快速上线</p>
                            <p>- 使用Git完成线上代码部署</p>
                            <p>- 公众号开发权限及功能接入</p>
                            <p>- 微信JSSDK接口API</p>
                            <p>- 微信场景项目开发与接入</p>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <p>- React Native初探</p>
                            <p>- React Native 项目导航</p>
                            <p>- React Native 项目文本框</p>
                            <p>- React Native 项目滚动分页</p>
                            <p>- React Native 项目第三方登录</p>
                            <p>- React Native 其他组件</p>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <p>- 自主原生Navtive Hybrid(iOS、Android)</p>
                            <p>- 第三方Hybrid框架Cordova/Phone gap</p>
                            <p>- 第三方Hybrid框架MUI + HTML5+</p><br><br>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="cont-dib">
                                <p>- express 介绍</p>
                                <p>- 安装和创建基于Express的项目</p>
                                <p>- Express 4.1x 初始化项目详解</p>
                                <p>- 路由简介</p>
                                <p>- 模板引擎EJS</p>
                                <p>- 模板引擎Pug（Jade）</p>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="cont-dib">
                                <p>- 数据可视化基础</p>
                                <p>- 零编程工具使用：ChartBlocks、Infogram、plotly、Raw、Tableau</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="cont-dib">
                                ...
                                <p>- D3.js 选择集与数据</p>
                                <p>- D3.js 高级应用</p>
                                <p>- D3.js 应用工具：NVD3、n3<p>-charts</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
        ...
        <a href="javascript:void(0)" class="btn" rel="nofollow">点击获取完整课程大纲体系</a>
        <a href="javascript:void(0)" class="btn" rel="nofollow">免费学习视频任你听</a>
    </div>
</div>
...
<div class="liangxin section">
    <div class="base">
        ...
        <div style="width:98%;"><a rel="nofollow" style="margin-left:500px;" href="javascript:void(0)" class="btn">点击咨询详情</a></div>
        <ul>
...
<div class="c7">
    ...
    <div id="auto-width">
        <div class="warp">
            ...
            <a rel="nofollow" href="javascript:void(0)">看看还有哪些企业选择鸿博学员？</a>
        </div>
    </div>
</div>
...
<div class="zixun section">
    <ul class="base zx_list">
        <li><a rel="nofollow" href="javascript:void(0)">有疑问点击咨询</a></li>
        <li><a rel="nofollow" href="javascript:void(0)">报名抢座开始学习</a></li>
        <li><a rel="nofollow" href="javascript:void(0)">查看免费教程视频</a></li>
    </ul>
</div>
