...
<script src="https://hm.baidu.com/hm.js?19b972123a261b3be88cf2d47bd66ccb"></script><script src="./templates/mobile/js/jquery.min.js"></script>
...
//<![CDATA[
window.__mirage2 = {petok:"9e4c6dbae5bbd629d28ed746597240e521416c7c-1557802967-1800"};
//]]>
</script>
...
<a>
<img data-cfsrc="./templates/mobile/src/icons/call.png" alt="电话" class="nav-call" href="010-57032333f" src="./templates/mobile/src/icons/call.png">
</a>
</div>
<div class="mNav">
<div class="mNav-close" style="line-height: 50px;"><img data-cfsrc="./templates/mobile/images/mNav_10.png" width="19" height="19" data-cfstyle="display: inline;width: 19px;height: 19px;" style="display: inline;width: 19px;height: 19px;" src="./templates/mobile/images/mNav_10.png"></div>
<ul style="margin-bottom: 00px;">
<li><a href="/Faculty.html"><img data-cfstyle="display: inline;" data-cfsrc="./templates/mobile/images/shizi.png" style="display: inline;" src="./templates/mobile/images/shizi.png"><span>师资</span></a></li>
<li><a href="/EmploymentInformation.html"><img data-cfstyle="display: inline;" data-cfsrc="./templates/mobile/images/jiuye.png" style="display: inline;" src="./templates/mobile/images/jiuye.png"><span>就业</span></a></li>
<li><a href="/phonebd.html"><img data-cfstyle="display: inline;" data-cfsrc="./templates/mobile/images/baoming.png" style="display: inline;" src="./templates/mobile/images/baoming.png"><span>报名</span></a></li>
<li><a href="/news.html"><img data-cfstyle="display: inline;" data-cfsrc="./templates/mobile/images/ITzixun.png" style="display: inline;" src="./templates/mobile/images/ITzixun.png"><span>IT咨询</span></a></li>
<li><a href="/StudentsStory.html"><img data-cfstyle="display: inline;" data-cfsrc="./templates/mobile/images/gushi.png" style="display: inline;" src="./templates/mobile/images/gushi.png"><span>故事</span></a></li>
<li><a href="/about/abouts.html"><img data-cfstyle="display: inline;" data-cfsrc="./templates/mobile/images/guanyu.png" style="display: inline;" src="./templates/mobile/images/guanyu.png"><span>关于</span></a></li>
<div class="clear"></div>
</ul>
</div>
</nav>
...
<div class="bd">
<div class="tempWrap" style="overflow:hidden; position:relative; width:320px"><ul style="width: 1280px; position: relative; overflow: hidden; padding: 0px; margin: 0px; left: -640px;"><li class="clone" style="float: left; width: 320px;">
...
<li class="scr7">职位</li>
<li class="scr7">学历</li>
<li class="scr6"><p class="p4">就业单位</p></li>
<li class="scr5 xinzi">薪资</li>
</ul>
<div id="scrollDiv" class="scrollDiv">
<div class="bd">
<div class="tempWrap" style="overflow:hidden; position:relative; height:192px"><ol style="height: 1056px; position: relative; padding: 0px; margin: 0px; top: -763px;"><li class="clone" style="height: 32px;">
<p class="scr4">乔**</p>
...
<p class="scr6">新浪</p>
<p class="scr5 xinzibg">25000</p>
</li><li class="clone" style="height: 32px;">
<p class="scr4">石**</p>
<p class="scr7">全栈工程师</p>
<p class="scr7">护理专业</p>
<p class="scr6">白果实业</p>
...
<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1600%; margin-left: -1280px;"><li class="li6 clone" style="width: 320px; float: left; display: block;">
<div class="slide">
...
</li></ul></div><ol class="flex-control-nav flex-control-paging"><li><a class="">电商</a></li><li><a class="">物流</a></li><li><a class="">旅游</a></li><li><a class="flex-active">社交</a></li><li><a>教育</a></li><li><a>金融</a></li></ol><ul class="flex-direction-nav"><li><a class="flex-prev" href="#">Previous</a></li><li><a class="flex-next" href="#">Next</a></li></ul></div>
</div>
</div>
...
<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 800%; margin-left: -320px;"><li class="slide clone" style="width: 320px; float: left; display: block;">
<ol>
<li>
<div class="bg">
...
</li></ul></div><ol class="flex-control-nav flex-control-paging"><li><a class="flex-active">1</a></li><li><a class="">2</a></li></ol></div>
</div>
...
<a href="/">
<div class="item">
<p><img data-cfsrc="./templates/mobile/src/icons/tab_home.png" class="img-responsive" src="./templates/mobile/src/icons/tab_home.png"></p>
<p>首页</p>
</div>
</a>
<a href="http://q.url.cn/ABULOl?_type=wpa&amp;qidian=true">
<div class="item">
<p><img data-cfsrc="./templates/mobile/src/icons/tab_zixun.png" class="img-responsive" src="./templates/mobile/src/icons/tab_zixun.png"></p>
<p>在线咨询</p>
</div>
</a>
<a href="/phonebd.html">
<div class="item">
<p><img data-cfsrc="./templates/mobile/src/icons/tab_baoming.png" class="img-responsive" src="./templates/mobile/src/icons/tab_baoming.png"></p>
<p>我要报名</p>
</div>
</a>
</div>
...
<script>
		...
		//	       ban轮播
	      jQuery(".ban  .slideBox").slide({mainCell:".bd ul",effect:"leftLoop",autoPlay:true,interTime:4000,delayTime:1000});
	       //	         薪资滚动
	        jQuery(".scrollDiv").slide({mainCell:".bd ol",autoPlay:true,effect:"topMarquee",vis:6,interTime:50,trigger:"click"});
	        $(function(){
	        //6大项目
