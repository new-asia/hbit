...
<HTML><HEAD><TITLE>404错误页面</TITLE><!--STATUS OK-->
    ...
    <![endif]-->
    <!--[if (lt IE 8.0)]><LINK href="/static/404/files/qbase.css" type=text/css
                               rel=stylesheet><![endif]--><!--[if (!IE)|(gte IE 8.0)]><!--><link href="/static/404/files/qbase_datauri.css" type=text/css rel=stylesheet><!--<![endif]-->
    ...
    <DIV class="mod-page-main wordwrap clearfix">
        <DIV class=x-page-container>
            <DIV class="mod-notfound grid-98"><IMG class=img-notfound height=320
                                                   src="/static/404/files/notfound.gif" width=520>
                ...
                <P style="FONT-SIZE: 14px; LINE-HEIGHT: 20px">您可以回到 <A
                            href="/">网站首页</A> 或到<A
                            onclick="history.back()" >上一页</A> </DIV></DIV></DIV></SECTION><FOOTER
        class="mod-footer mod-cs-footer">
    <DIV class="clearfix hidden-box"></DIV>
    <DIV class=footer-box>

        <DIV class=copy-box>©北京鸿博互联软件有限公司&nbsp;www.hongboit.net</DIV></DIV></FOOTER>
